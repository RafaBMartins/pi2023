          ...
          <li>
            <div class="card mb-4 d-flex align-items-top p-2">
              <div class="d-flex align-items-top p-2">
                ...
                <div class="w-100">
                  <!--titulo-->
                  <h4 href="perfilestabelecimento.html" class="card-title ms-2">Grelha do Zêzere<img class="img-fluid m-1"
                  ...
                  <div class="m-2">
                    ...
                    <a href="perfilestabelecimento.html" class="blue ms-2">Ver Mais</a>
                  </div>
                </div>
              </div>
            </div>
